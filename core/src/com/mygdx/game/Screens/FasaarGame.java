...
import com.mygdx.game.Entities.Monsters.Cthulhu;
import com.mygdx.game.Entities.Monsters.ForestLurker;
import com.mygdx.game.Entities.Monsters.Python;
import com.mygdx.game.Entities.Player;
import com.mygdx.game.MapDecals.MapDecals;
import com.mygdx.game.Serverfiles.GameState;
...
public class FasaarGame extends ApplicationAdapter {
	int id;
	String color;
	...
	public FasaarGame(int id, String color) {
		this.id = id;
		this.color = color;
	}
	...
	public void render() {
		...
		if (Gdx.input.isKeyJustPressed(Input.Keys.E)) {
			if (gameStates.get(gameStateIndex).orb != null && mainPlayer.getPosition().dst(gameStates.get(gameStateIndex).orb.position) < 50) {
